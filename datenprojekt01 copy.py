...
result = descriptive_values('Datensatz_4_Beschleunigung_2.csv', 'Absolute Beschleunigung (m/s^2)', val=False)
for i in result:
    print(i)

# Beispiel für die sortierte Liste
result_sorted = descriptive_values('Datensatz_4_Beschleunigung_2.csv', 'Absolute Beschleunigung (m/s^2)', True,True,'Sortierte Beschleunigung.csv')
